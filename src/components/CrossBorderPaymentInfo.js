...
const CrossBorderPaymentInfo = () => {
  ...
  // Initialize form with existing flow state
  ...
  const validateForm = () => {
    ...
    if (!formData.routingNumber.trim() && !formData.swiftCode.trim()) {
      newErrors.routingNumber = 'Routing number or SWIFT code is required';
    }
    ...
    if (!formData.purposeOfPayment.trim()) {
      newErrors.purposeOfPayment = 'Purpose of payment is required';
    }
  ...
  const handleContinue = () => {
    ...
    // Update flow state with form data
    updateFlowState(formData);
    
    // Navigate to payment description
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-lg border ${errors.beneficiaryName ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors`}
              />
              {errors.beneficiaryName && (
                <p className="text-error text-sm">{errors.beneficiaryName}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-lg border ${errors.beneficiaryBank ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors`}
              />
              {errors.beneficiaryBank && (
                <p className="text-error text-sm">{errors.beneficiaryBank}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors.beneficiaryAccountNumber ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors`}
                />
                {errors.beneficiaryAccountNumber && (
                  <p className="text-error text-sm">{errors.beneficiaryAccountNumber}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <select
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors.accountType ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text focus:outline-none focus:border-primary-blue transition-colors`}
                >
                ...
                {errors.accountType && (
                  <p className="text-error text-sm">{errors.accountType}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors.routingNumber ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors`}
                />
                {errors.routingNumber && (
                  <p className="text-error text-sm">{errors.routingNumber}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border border-neutral-300 bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors`}
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={3}
                className={`w-full px-4 py-3 rounded-lg border ${errors.beneficiaryAddress ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors resize-none`}
              />
              {errors.beneficiaryAddress && (
                <p className="text-error text-sm">{errors.beneficiaryAddress}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors.phoneNumber ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors`}
                />
                {errors.phoneNumber && (
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors.email ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors`}
                />
                {errors.email && (
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={2}
                className={`w-full px-4 py-3 rounded-lg border ${errors.purposeOfPayment ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors resize-none`}
              />
              {errors.purposeOfPayment && (
                <p className="text-error text-sm">{errors.purposeOfPayment}</p>
              )}
            </div>
            ...
            <button
              ...
              className="w-full py-3 bg-primary-blue text-white text-lg font-bold rounded-lg hover:bg-primary-blue/90 transition-all duration-300 mt-6"
            >
              Continue
            </button>
          </div>
...
export default CrossBorderPaymentInfo;
