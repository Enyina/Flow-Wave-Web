        ...
        <div className={`w-full max-w-lg ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className="bg-secondary-light p-4 rounded-lg">
            <div className="flex items-start gap-2">
              {/* Avatar */}
              <div className="w-8 h-8 rounded-full overflow-hidden bg-primary-blue flex-shrink-0">
                <img 
                  src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=66&h=66&fit=crop&crop=face" 
                  alt="User Avatar" 
              ...
              <div className="flex-1">
                ...
                <p className="text-neutral-gray text-xs leading-relaxed">
                  No verification needed. However you have a transfer limit of 1,000 USD/Month and 10,000 USD/Year
                </p>
              </div>
            </div>
          </div>
