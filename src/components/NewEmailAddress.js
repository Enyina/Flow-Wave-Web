        ...
        <div className={`w-full max-w-lg ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col gap-6 mb-8">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className={`flex px-4 py-3 items-center rounded-lg border ${
                errors.email ? 'border-error' : 'border-neutral-gray'
              } bg-white focus-within:border-primary-blue transition-colors`}>
                <input
                  type="email"
                  placeholder="Enter new email address"
                  value={formData.email}
                  onChange={(e) => handleInputChange('email', e.target.value)}
                  className="flex-1 border-none outline-none bg-transparent text-neutral-dark placeholder:text-neutral-gray/70"
                />
              </div>
              {errors.email && (
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className={`flex px-4 py-3 items-center rounded-lg border ${
                errors.confirmEmail ? 'border-error' : 'border-neutral-gray'
              } bg-white focus-within:border-primary-blue transition-colors`}>
                <input
                  type="email"
              ...
              {errors.confirmEmail && (
                <span className="text-error text-xs">{errors.confirmEmail}</span>
              )}
            </div>
          </div>
