          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-lg border ${errors.description ? 'border-error' : 'border-neutral-300'} bg-white dark:bg-dark-surface text-neutral-dark dark:text-dark-text placeholder:text-neutral-300 focus:outline-none focus:border-primary-blue transition-colors`}
              />
              {errors.description && (
