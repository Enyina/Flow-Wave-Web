    ...
    <div className="min-h-screen bg-white dark:bg-dark-bg transition-colors duration-300">
      ...
      <header className={`flex justify-between items-center px-4 lg:px-20 py-4 lg:py-6 ${hasAnimated ? 'animate-slide-in-down animate-once' : 'opacity-0'}`}>
        ...
        <div className="flex items-center gap-4 lg:gap-10">
          ...
          <button className="p-2 rounded-full bg-primary-blue/10 text-primary-blue transition-all duration-200">
            <svg width="40" height="40" viewBox="0 0 50 50" fill="none" className="w-8 h-8 lg:w-10 lg:h-10">
      ...
      <main className="flex flex-col items-center justify-center px-4 lg:px-0 pb-24 min-h-[calc(100vh-200px)]">
        <div className={`w-full max-w-lg flex flex-col items-center ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          {/* Title */}
          <h1 className="text-center text-2xl lg:text-3xl font-bold text-primary-pink mb-16">
            Notification
          </h1>

          {/* Empty State */}
          <div className="text-center">
            <p className="text-neutral-dark dark:text-dark-text text-base max-w-md leading-relaxed">
              Nothing to see here, all of your notifications will show here once you have them
            </p>
          </div>
        </div>
      </main>
