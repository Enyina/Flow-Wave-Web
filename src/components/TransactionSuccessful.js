        ...
        <div className={`w-full max-w-lg flex flex-col items-center ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className="mb-10">
            <svg width="235" height="173" viewBox="0 0 235 173" fill="none" className="w-60 h-44">
              <path d="M234.872 165.395C234.872 169.474 182.325 172.781 117.499 172.781C52.6787 172.781 0.12793 169.474 0.12793 165.395C0.12793 161.317 52.6795 158.012 117.499 158.012C182.326 158.012 234.872 161.317 234.872 165.395Z" fill="#ACBFE2"/>
              ...
              <path d="M131.367 112.828C133.755 116.717 131.346 122.546 125.976 125.843C120.614 129.137 114.322 128.654 111.935 124.763L84.4731 80.0365C82.0832 76.1446 84.4918 70.3215 89.864 67.0252C95.2262 63.729 101.518 64.2141 103.906 68.103L131.367 112.828Z" fill="#F6F5F7"/>
              <path d="M130.367 122.589C127.073 127.951 120.051 129.635 114.689 126.341C109.316 123.047 107.64 116.026 110.934 110.655L148.78 48.9757C152.074 43.6081 159.095 41.9269 164.465 45.2208C169.83 48.5147 171.514 55.5339 168.22 60.9015L130.367 122.589Z" fill="#F6F5F7"/>
            </svg>
          </div>

          {/* Success Message */}
          <div className="text-center mb-10">
            <h1 className="text-2xl lg:text-3xl font-bold text-neutral-dark dark:text-dark-text mb-4">
              Transaction Successful
            </h1>
            <p className="text-neutral-dark dark:text-dark-text text-base">
              Your transaction was successful, recipient should receive in no time.
            </p>
          </div>
          ...
          <div className="w-full space-y-4">
            ...
            <button
              ...
              className="w-full py-3 border border-neutral-300 text-neutral-dark text-lg font-bold rounded-lg hover:bg-neutral-50 transition-all duration-300"
            >
