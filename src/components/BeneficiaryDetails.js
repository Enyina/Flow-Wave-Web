...
const BeneficiaryDetails = () => {
  ...
  const { receiveAmount } = useCurrency();
  ...
  // Prefill form with selected recipient data
  useEffect(() => {
    if (flowState.selectedRecipient) {
      setFormData({
        beneficiaryName: flowState.selectedRecipient.fullName || flowState.selectedRecipient.name || '',
        accountNumber: flowState.selectedRecipient.accountNumber || '',
        routingNumber: flowState.selectedRecipient.routingNumber || '',
        swiftCode: flowState.selectedRecipient.swiftCode || '',
        bankName: flowState.selectedRecipient.bankName || flowState.selectedRecipient.bank || '',
        beneficiaryAddress: flowState.selectedRecipient.address || '',
        beneficiaryEmail: flowState.selectedRecipient.email || '',
        beneficiaryPhone: flowState.selectedRecipient.phone || ''
      });
    }
  }, [flowState.selectedRecipient]);
  ...
  const validateForm = () => {
    ...
    if (!formData.beneficiaryPhone.trim()) {
      ...
      newErrors.beneficiaryPhone = 'Invalid phone number format';
    }
  ...
  const handleSubmit = (e) => {
    ...
    // Update transaction data with beneficiary information
    updateFlowState({
      ...flowState,
      beneficiary: formData,
      currentStep: 'virtual-account'
    });
    ...
    <div className="min-h-screen bg-white dark:bg-dark-bg transition-colors duration-300">
      ...
      <main className="flex flex-col items-center px-4 lg:px-0 pb-24">
        <div className={`w-full max-w-lg ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          {/* Beneficiary Details Title */}
          <h1 className="text-center text-2xl lg:text-3xl font-bold text-primary-pink mb-8 lg:mb-10">
            Beneficiary Details
          </h1>

          {/* Transaction Summary */}
          <div className={`mb-6 p-4 rounded-lg bg-primary-light/20 ${hasAnimated ? 'animate-slide-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
            <div className="text-center mb-3">
              <p className="text-sm text-neutral-gray">Amount to Send</p>
              <p className="text-xl font-bold text-primary-blue">
                {formatCurrency(flowState.sendAmount, flowState.fromCurrency?.code)}
              </p>
            </div>
            <div className="text-center">
              <p className="text-sm text-neutral-gray">Receiver Gets</p>
              <p className="text-xl font-bold text-primary-blue">
                {formatCurrency(receiveAmount, flowState.toCurrency?.code)}
              </p>
            </div>
          </div>

          {/* Beneficiary Form */}
          <form onSubmit={handleSubmit} className={`space-y-4 ${hasAnimated ? 'animate-slide-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.6s' }}>
            {/* Beneficiary Name */}
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-lg border ${errors.beneficiaryName ? 'border-error' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent`}
                placeholder="Enter beneficiary's full name"
              />
              {errors.beneficiaryName && (
                <p className="text-error text-xs mt-1">{errors.beneficiaryName}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-3 rounded-lg border ${errors.accountNumber ? 'border-error' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-3 rounded-lg border ${errors.routingNumber ? 'border-error' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-3 rounded-lg border ${errors.swiftCode ? 'border-error' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent`}
                placeholder="Enter SWIFT code"
              />
              {errors.swiftCode && (
                <p className="text-error text-xs mt-1">{errors.swiftCode}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-3 rounded-lg border ${errors.bankName ? 'border-error' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 rounded-lg border ${errors.beneficiaryEmail ? 'border-error' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent`}
                  placeholder="email@example.com"
                />
                {errors.beneficiaryEmail && (
                  <p className="text-error text-xs mt-1">{errors.beneficiaryEmail}</p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 rounded-lg border ${errors.beneficiaryPhone ? 'border-error' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent`}
                  placeholder="+1234567890"
                />
                {errors.beneficiaryPhone && (
                  <p className="text-error text-xs mt-1">{errors.beneficiaryPhone}</p>
                )}
              </div>
            </div>
      ...
      {/* Bottom Navigation */}
      <nav className={`fixed bottom-0 left-0 right-0 bg-white dark:bg-dark-surface shadow-soft dark:shadow-dark-soft px-6 py-6 ${hasAnimated ? 'animate-slide-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '1s' }}>
