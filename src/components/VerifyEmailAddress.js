        ...
        <div className={`w-full max-w-lg ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col items-center gap-10">
            ...
            <div className="flex flex-col items-center gap-4 text-center">
              <h1 className="text-primary-pink text-3xl font-bold font-inter leading-10">
                Verify your email address
              </h1>
              <p className="text-neutral-gray text-base font-normal font-inter leading-5">
            ...
            <div className="flex items-center justify-center gap-6">
              {verificationCode.map((digit, index) => (
                <input
                  ...
                  className="w-12 h-16 rounded-lg bg-primary-light border-0 text-center text-xl font-bold text-neutral-dark focus:outline-none focus:ring-2 focus:ring-primary-blue"
                />
              ))}
            </div>
            ...
            <div className="w-full flex flex-col items-center gap-4">
              <button
                ...
                className="w-full px-3 py-3 bg-primary-blue rounded-lg flex justify-center items-center gap-2 hover:bg-primary-blue/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <div className="text-center">
                {showResend ? (
                  <button
                    ...
                    className="text-primary-blue text-xs font-normal font-inter leading-5 hover:underline"
                  >
                    Resend
                  </button>
                ) : (
                  <p className="text-neutral-dark text-xs font-normal font-inter leading-5">
