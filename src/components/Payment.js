...
const Payment = () => {
  ...
  // Calculate total payment (amount + fee)
  ...
  const handlePaymentSuccess = (response) => {
    // Update flow state with payment information
    updateFlowState({
      ...flowState,
    ...
    <div className="min-h-screen bg-white dark:bg-dark-bg transition-colors duration-300">
      ...
      <main className="flex flex-col items-center px-4 lg:px-0 pb-24">
        <div className={`w-full max-w-lg ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          {/* Payment Summary */}
          <div className={`bg-primary-light/20 rounded-lg p-6 mb-6 ${hasAnimated ? 'animate-slide-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
            <h3 className="text-lg font-bold text-neutral-dark dark:text-dark-text mb-4">Payment Summary</h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-neutral-gray">Card, Bank Transfer, USSD</p>
                    </div>
                  </div>
          ...
          {/* Help Text */}
          <p className={`text-center text-sm text-neutral-gray mt-4 ${hasAnimated ? 'animate-fade-in animate-once' : 'opacity-0'}`} style={{ animationDelay: '1.2s' }}>
