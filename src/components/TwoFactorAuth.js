    ...
    <div className="min-h-screen bg-white dark:bg-dark-bg transition-colors duration-300">
      ...
      <main className="flex flex-col items-center px-4 lg:px-0 pb-32">
        <div className={`w-full max-w-lg ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          {/* Section Header */}
          <div className="mb-8">
            <h2 className="text-neutral-dark text-base font-normal mb-1">
          ...
          <div className="bg-secondary-light p-4 rounded-lg">
            <div className="flex justify-between items-center">
              <div className="flex-1">
                <div className="mb-1">
                  <h3 className="text-neutral-dark text-base font-normal">
                    Two-Factor Authentication
                  </h3>
                </div>
                <button 
                  onClick={handleChangePin}
                  className="text-primary-blue text-xs underline hover:text-primary-pink transition-colors"
                >
                  Change pin
                </button>
              </div>
              ...
              <button
                ...
                className={`relative inline-flex w-10 h-6 rounded-full transition-colors duration-200 ease-in-out ${
                  isTwoFactorEnabled ? 'bg-primary-blue' : 'bg-neutral-gray'
                }`}
              >
                <span
                  className={`inline-block w-5 h-5 rounded-full bg-white shadow-lg transform transition-transform duration-200 ease-in-out ${
                    isTwoFactorEnabled ? 'translate-x-4' : 'translate-x-0.5'
                  } mt-0.5`}
                />
              </button>
            </div>
