    ...
    <div className="min-h-screen bg-white dark:bg-dark-bg transition-colors duration-300">
      ...
      <main className="flex flex-col items-center px-4 lg:px-0 pb-24">
        <div className={`w-full max-w-lg ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className="bg-secondary-light rounded-lg p-6 mb-6">
            <div className="flex flex-col items-center gap-4">
              {/* Logo */}
              <div className="w-14 h-10">
                <svg width="58" height="43" viewBox="0 0 58 43" fill="none" className="w-full h-full">
                  <defs>
                    <linearGradient id="flowwave-gradient-small" x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  <path d="M8 28C8 28 12 20 20 20C28 20 32 28 40 28C48 28 52 20 52 20V43H0V20C0 20 4 28 8 28Z" fill="url(#flowwave-gradient-small)" />
                  <path d="M4 18C4 18 8 10 16 10C24 10 28 18 36 18C44 18 48 10 48 10V33H-4V10C-4 10 0 18 4 18Z" fill="url(#flowwave-gradient-small)" opacity="0.7" />
                  <path d="M0 8C0 8 4 0 12 0C20 0 24 8 32 8C40 8 44 0 44 0V23H-8V0C-8 0 -4 8 0 8Z" fill="url(#flowwave-gradient-small)" opacity="0.4" />
                </svg>
              </div>
              ...
              <div className="text-center">
                <p className="text-neutral-dark text-base mb-4">
                  Transfer to {transactionData.recipient.name}
                </p>
          ...
          {/* Recipient Details */}
          <div className="bg-secondary-light rounded-lg p-6 mb-4">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Recipient Name</span>
                <span className="text-neutral-dark text-xs">{transactionData.recipient.name}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Account Number</span>
                <span className="text-neutral-dark text-xs">{transactionData.recipient.accountNumber}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Bank</span>
                <span className="text-neutral-dark text-xs">{transactionData.recipient.bank}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Routing Number</span>
                <span className="text-neutral-dark text-xs">{transactionData.recipient.routingNumber}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Payment Description</span>
                <span className="text-neutral-dark text-xs">{transactionData.recipient.description}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-secondary-light rounded-lg p-6 mb-8">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Reference ID</span>
                <span className="text-neutral-dark text-xs">{transactionData.details.referenceId}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Exchange Rate</span>
                <span className="text-neutral-dark text-xs">{transactionData.details.exchangeRate}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Received by recipient</span>
                <span className="text-neutral-dark text-xs">{transactionData.details.receivedAmount}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Transfer Fee</span>
                <span className="text-neutral-dark text-xs">{transactionData.details.transferFee}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-dark text-xs">Total</span>
                <span className="text-neutral-dark text-xs font-semibold">{transactionData.details.total}</span>
              </div>
            </div>
          </div>
