...
const ReceiptProcessing = () => {
  ...
  const [processingStatus, setProcessingStatus] = useState('processing'); // processing, completed
    ...
    const interval = setInterval(() => {
      setCountdown((prev) => {
        if (prev <= 1) {
          ...
          // Navigate to completed receipt after a short delay
          setTimeout(() => {
  ...
  }, [navigate, flowState, updateFlowState]);
        ...
        <div className={`w-full max-w-lg ${hasAnimated ? 'animate-fade-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className={`text-center mb-8 ${hasAnimated ? 'animate-slide-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
            ...
            <p className="text-neutral-gray">
              Your transaction is being processed. You will receive a notification when it's completed.
            </p>
          </div>

          {/* Processing Receipt */}
          <div className={`bg-white border-2 border-gray-200 rounded-lg shadow-lg p-6 mb-6 ${hasAnimated ? 'animate-slide-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.6s' }}>
            {/* Receipt Header */}
            <div className="text-center mb-6 pb-4 border-b border-gray-200">
              ...
              <div className="mt-3 inline-flex items-center gap-2 px-3 py-1 bg-yellow-100 rounded-full">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <div className="space-y-2">
                ...
                <div className="flex justify-between pt-2 border-t border-gray-300">
                  <span className="text-neutral-gray">Beneficiary Receives:</span>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-blue-800">Processing Transaction</span>
              </div>
              <p className="text-xs text-blue-700">
                Your transaction is being processed. This usually takes a few hours.
              </p>
            </div>
          </div>

          {/* Countdown Timer */}
          <div className={`text-center mb-6 ${hasAnimated ? 'animate-fade-in animate-once' : 'opacity-0'}`} style={{ animationDelay: '0.8s' }}>
          ...
          {/* Action Buttons */}
          <div className={`space-y-3 ${hasAnimated ? 'animate-slide-in-up animate-once' : 'opacity-0'}`} style={{ animationDelay: '1s' }}>
            <button
