...
const WelcomeOnboard = ({ onNext }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen p-8 xl:p-10 bg-gradient-to-br from-slate-50 to-slate-200">
      ...
      {showProfileSuccess && (
        <div className="fixed inset-0 bg-white/10 backdrop-blur-sm flex items-center justify-center z-50 animate-modal-fade-in animate-once">
          <div className="flex flex-col items-center gap-10 p-10 max-w-lg w-4/5 rounded-3xl bg-white shadow-large animate-modal-slide-up animate-once">
            ...
            <p className="text-neutral-dark text-center">Your profile has been created</p>
        ...
        <div className="fixed inset-0 bg-white/10 backdrop-blur-sm flex items-center justify-center z-50 animate-modal-fade-in animate-once">
          <div className="flex flex-col items-center gap-10 p-10 max-w-lg w-4/5 rounded-3xl bg-white shadow-large animate-modal-slide-up animate-once">
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-dark">Let's help you send money to anywhere, at anytime.</p>
            </div>
